...
export default function SlideShow({ slides }) {
  ...
  function handleRightButton() {
    const currentPostion = slideContainerRef.current.scrollLeft;
    if (currentPostion)
      currentPostion =
        currentPostion + slideContainerRef.current.children[0].clientWidth;
  }
  ...
  return (
    <div className={styles.carousel}>
      ...
      <div ref={slideContainerRef} className={styles.slideShowContainer}>
        {imageElements}
      </div>
    </div>
  );
